fn main() {
   ...
   println!();
   println!("{} is aimed at developing competent, creative, imperative, entrepreneurial and ethically-minded persons, capable of creating value in the diverse fields of Computer Science.",w3)
