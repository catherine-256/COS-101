...
fn main() {
    ...
    println!("Input number of developers:");
    io::stdin().read_line(&mut devs_input).expect("Failed to read line");
    ...
    for i in 0..num_devs {
        ...
        println!("Input your name {}: ", i + 1);
        io::stdin().read_line(&mut dev_name).expect("Failed to read line");

        println!("Input number of years of experience {}: ", i + 1);
        io::stdin().read_line(&mut dev_exp).expect("Failed to read line");
    ...
    let mut maximum_name = "0 developers".to_string();
    ...
    println!( "Developer with the highest experience: {} with {} years",
